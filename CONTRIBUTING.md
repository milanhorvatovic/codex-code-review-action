...
7. **CLIs.** Each entry script ships a `main(argv=None) -> int` that parses `argparse` arguments and exits with `sys.exit(main())`. Capabilities reference the script as `python3 scripts/<name>.py --help`.
